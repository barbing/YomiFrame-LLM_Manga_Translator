...
def _build_audit(context: dict[str, Any], regions: list[dict]) -> dict[str, Any]:
        ...
        audit_regions.append(
            {
                ...
                "cleanup_pilot_class": meta.get("cleanup_pilot_class"),
                "cleanup_pilot_status": meta.get("cleanup_pilot_status"),
                "cleanup_pilot_failure_class": meta.get("cleanup_pilot_failure_class"),
                "cleanup_pilot_plan_id": meta.get("cleanup_pilot_plan_id"),
                "cleanup_pilot_result_id": meta.get("cleanup_pilot_result_id"),
                "cleanup_pilot_proof_id": meta.get("cleanup_pilot_proof_id"),
                "cleanup_pilot_renderer_action": meta.get("cleanup_pilot_renderer_action"),
                "cleanup_pilot_cleanup_committed": meta.get("cleanup_pilot_cleanup_committed"),
                "cleanup_pilot_allowed_area": meta.get("cleanup_pilot_allowed_area"),
                "cleanup_pilot_erase_mask_bbox": meta.get("cleanup_pilot_erase_mask_bbox"),
    ...
    return {
        ...
        "cleanup_dense_mask_contracts": context.get("cleanup_dense_mask_contracts") or {},
        ...
        "cleanup_pilot_status": context.get("cleanup_pilot_status") or {},
